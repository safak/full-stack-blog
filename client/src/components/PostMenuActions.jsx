...
const PostMenuActions = ({ post }) => {
    ...
    const { isLoading, error, data:savedPosts } = useQuery({
        queryKey: ["savedPosts"],
        queryFn: async () => {
        ...
        <div className="">
            ...
            :  (
                    ...
                    >
                        ...
                        <span className="text-primary-text-color">Save post</span>
                        {saveMutation.isLoading && (
            ...
            {isAdmin && (
                ...
                >
                    ...
                    <span className="text-primary-text-color">Feature post</span>
                    {featureMutation.isLoading && (
